...
//               <p><a href="#service" onClick={(e) => handleNavigation(e, 'service')}>Services</a></p>
//               <p><a href="#blog" onClick={(e) => handleNavigation(e, 'blog')}>Blogs</a></p>
//               <p><Link to="/justmypictures" onClick={() => setToggleMenu(false)}>Products</Link></p>
//               {renderActionButton()}
//             </div>
//           )}
//         </div>
...
const Navbar = () => {
  ...
  const navigate = useNavigate();
  const isOnPicturePage = location.pathname === "/justmypictures";
  const isOnPicturePerfect = location.pathname === "/pictureperfect" || location.pathname === "/pictureperfect2";
        ...
        {isOnPicturePerfect && (
          <div className="inv__navbar-center">
            ...
            <p>
              <Link 
                to="/pictureperfect2" 
                style={location.pathname === "/pictureperfect2" ? { textDecoration: 'underline', textUnderlineOffset: '5px' } : {}}
              >
                Background-Remover
              </Link>
            </p>
            <p>
              <Link 
                to="/pictureperfect" 
                style={location.pathname === "/pictureperfect" ? { textDecoration: 'underline', textUnderlineOffset: '5px' } : {}}
              >
                Picture-Enhancer
              </Link>
            </p>
            ...
            <div className="inv__navbar-menu_container scale-up-center">
              {!isOnPicturePerfect ? (
                ...
                <>
                  ...
                  <p><Link to="/pictureperfect2" onClick={() => setToggleMenu(false)}>RemoveBG</Link></p>
                  <p><Link to="/pictureperfect" onClick={() => setToggleMenu(false)}>Just My Pictures</Link></p>
                </>
              )}
              {renderActionButton()}
            </div>
